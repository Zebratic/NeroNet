...
namespace NeroClient.Helpers.Services.StreamLibrary.src
{
    ...
    public class CRC32 : HashAlgorithm
    {
        ...
        public new byte[] ComputeHash(Stream inputStream)
        {
            ...
            int bytesRead;
            while ((bytesRead = inputStream.Read(buffer, 0, 4096)) > 0) HashCore(buffer, 0, bytesRead);
            return HashFinal();
        }
        ...
        private static readonly uint _allOnes = 0xffffffff;
